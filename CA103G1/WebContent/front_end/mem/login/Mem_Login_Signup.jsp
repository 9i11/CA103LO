          ...
          <form METHOD="post" action="<%=request.getContextPath() %>/mem/mem.do" >
           <c:if test="${not empty errorMsgs}">
            ...
            <div class="input-group input-group-lg">
              ...
              <input type="password" name="regPassword" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm " required>
            </div><br>
            ...
            <div class="input-group input-group-lg">
              ...
              <input type="password" name="confirmedPsw" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm" required>
            </div><br>
