...
.field_set {
	...
	border: 2px white(internal value);
}
</style>
</head>
		...
		<div class="col-sm-12 formContent center text-light">
			<form action="<%=request.getContextPath()%>/mem/mem.do"
				...
				<div class="form-group ">
					...
					<label>上傳圖片:</label> <input type="file" class="upl"
						name="memPhoto"> <input type="submit" value="上傳">
				</div>
				<div class="form-group">
					<label>會員暱稱:</label> <input type="text" name="memName"
						class="form-control" value=${memVO.mem_name }>
				</div>
				<div class="form-group">
					<label>會員生日:</label> <input type="date" name="memBirth"
						class="form-control">
				</div>
				<div class="form-group">
					<label>會員信箱:</label> <input type="email" name="memEmail"
						class="form-control">
				</div>
				<div class="form-group">
					...
					<fieldset>
							...
							<tr>
								<td><div>
										<input type="checkbox" id="scales" name="feature"
											value="scales" checked /> <label for="scales">Scales</label>
									</div></td>
						...
						<label class="checkbox-inline"><input type="checkbox" value="">45</label>
						<label
